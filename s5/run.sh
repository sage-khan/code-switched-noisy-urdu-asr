...
##Either use normal LM
#local/prepare_lm.sh ##Ensure lexicon.txt is in the said directory which in this case is ${kaldi-recipe-root}/data/local/lang

##OR use subword
#local/prepare_lm_subword.sh ##Ensure lexicon.txt is in the said directory which in this case is ${kaldi-recipe-root}/data/local/lang
...
#utils/format_lm_sri.sh data/lang data/local/lm/lm.gz data/local/lang/lexicon.txt data/lang_test

utils/format_lm.sh data/lang data/local/lm/lm.gz data/local/lang/lexicon.txt data/lang_test

utils/get_utt2dur.sh data/train
utils/get_utt2dur.sh data/test


utils/validate_lang.pl data/lang
utils/validate_dict_dir.pl data/local/lang
