...
\usepackage{authblk}
% Define the title, authors, and affiliations
...
\title{\MakeUppercase \Large \textbf{Code-Switched Urdu ASR for Noisy Telephonic Environment using Data-Centric Approach with Hybrid HMM and CNN-TDNN}}

\affil[1]{%
  Muhammad Danyal "Sage" Khan \textsuperscript{1} \thanks{Corresponding Author} \\ 
  Department of Cyber Security, Pakistan Navy Engineering College, National University of Science and Technology, Karachi, Pakistan\\
  \texttt{sagekhanofficial@gmail.com}
}

\affil[2]{%
  Usama Pervaiz \textsuperscript{2} \\
  Faculty of Information Technology And Computer Science, University of Central Punjab, Lahore, Pakistan\\
  \texttt{usamapervaiz0333@gmail.com}
}

\affil[3]{%
  Raheem Ali \textsuperscript{3}\\
...
\affil[4]{%
  Dr. Arshad Aziz \textsuperscript{4}\\
  Department of Cyber Security, Pakistan Navy Engineering College, National University of Science and Technology, Karachi, Pakistan\\
  \texttt{dr\_arshadaziz@yahoo.com}
}

\affil[5]{%
  Usman Aamer \textsuperscript{5}\\
  Faculty of Information Technology And Computer Science, University of Central Punjab, Lahore, Pakistan\\
  \texttt{usmanaamer01@gmail.com}
}

\affil[6]{%
  Hameed Afzal \textsuperscript{6}\\
  Department of Cyber Security, Pakistan Navy Engineering College, National University of Science and Technology, Karachi, Pakistan\\
  \texttt{hameedafzal999@gmail.com}
}



% \author[1]{Muhammad Danyal "Sage" Khan}
% \author[2]{Usama Pervaiz}
% \author[3]{Raheem Ali}
% \author[4]{Dr. Arshad Aziz}
% \author[5]{Usman Aamer}
% \author[6]{Jawad Hassan}
...
% Define title format
\titleformat{\section}{\centering \MakeUppercase}{\thesection}{1em}{}
...
\hline
\vspace{12pt}
\textbf{\textit{Submitted:}} \hfill \textbf{\textit{Accepted:}} \hfill \textbf{\textit{Published:}}
\vspace{12pt}
\rule{\textwidth}{0.4pt} % Horizontal line
\vspace{12pt}
\newpage
\textit{\textbf{Abstract: Call Centers are an effective medium for businesses, organizations and even government institutions to interact with their clients despite the availability of mobile apps and websites. These centres have huge amounts of audio data which can be used for achieving valuable business insights. This requires transcription of phone calls which is a manually tedious task to perform. An effective Automated Speech Recognition system can accurately transcribe these calls, making it easier to search through call history for specific context and content with very little time and manual effort. With text transcription available calls can be automatically monitored, improving QoS through keyword search and sentiment analysis. ASR for Call Center requires more robustness as telephonic environments are generally noisy. Moreover, there are many low-resource languages that are on the verge of extinction which can be preserved with the help of Automatic Speech Recognition Technology. Urdu is the $10^{th}$ most widely spoken language in the world, with 231,295,440 worldwide still remaining a resource-constrained language in ASR. Regional call-centre conversations operate in the local language, with a mix of English numbers and technical terms generally causing a "code-switching" problem. Hence, this paper describes an implementation framework of a resource-efficient Automatic Speech Recognition/ Speech to Text System in a noisy call-centre environment using Chain Hybrid HMM and CNN-TDNN for Code-Switched Urdu Language. Using the Hybrid HMM-DNN approach allowed us to utilize the advantages of Neural Networks with less labelled data. Adding CNN with TDNN has shown to work better in noisy environments due to CNN's additional frequency dimension which captures extra information from noisy speech, thus improving accuracy. We collected data from various open sources and labelled some of the unlabelled data after analysing its general context and content from the Urdu language as well as from commonly used words from other languages, primarily English and were able to achieve WER of 5.2\% with noisy as well as clean environment in isolated words or numbers as well as in continuous spontaneous speech.}}
\newline
\newline 
\textit{\textbf{Index Terms: Speech Recognition \and ASR \and Call Center \and Audio transcription \and Urdu language \and Code-switched Urdu ASR \and Speech to Text \and AI \and Cyber Security \and ASR for Resource Constrained Environment \and ASR for Noisy Environment \and ASR for Low Resource Languages\and Under-Resourced Languages}}
\newpage
